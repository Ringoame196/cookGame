...
class CookingData {
    ...
    fun mix(ingredients: MutableList<String>): ItemStack? {
        ...
        val hamburger = mutableListOf<String>("${ChatColor.YELLOW}チーズ", "${ChatColor.YELLOW}バンズ", "${ChatColor.YELLOW}ハンバーグ")
        ...
        val shari = mutableListOf<String>("ライス", "${ChatColor.GOLD}お酢")
        val nigiriOfTuna = mutableListOf<String>("シャリ", "${ChatColor.RED}マグロの切り身")
        val nigiriOfSalmon = mutableListOf<String>("シャリ", "${ChatColor.GOLD}サーモンの切り身")
        val nigiriOfSquid = mutableListOf<String>("シャリ", "イカの切り身")
